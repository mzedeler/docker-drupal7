...
// Trying to load mysql confituration from environment
$database['default']['default'] = array(
    'driver' => 'mysql',
    'database' => isset($_ENV['MYSQL_DATABASE']) ? $_ENV['MYSQL_DATABASE'] : 'drupal7',
    'username' => isset($_ENV['MYSQL_USER']) ? $_ENV['MYSQL_USER'] : 'drupal7',
    'password' => isset($_ENV['MYSQL_PASSWORD']) ? $_ENV['MYSQL_PASSWORD'] : 'drupal7',
